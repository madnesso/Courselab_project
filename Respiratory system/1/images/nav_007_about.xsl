...
<div>
	...
	<img border="0">
		...
		<xsl:attribute name="src">
			<xsl:if test="standard='yes'"><xsl:value-of select="$imagesFolder"/><xsl:value-of select="tabcolor"/>/tab_about_0.gif</xsl:if>
	...
	<img border="0">
		...
		<xsl:attribute name="src">
			<xsl:if test="standard='yes'"><xsl:value-of select="$imagesFolder"/><xsl:value-of select="tabcolor"/>/tab_about_1.gif</xsl:if>
	...
	<img border="0">
		...
		<xsl:attribute name="src">
			<xsl:if test="standard='yes'"><xsl:value-of select="$imagesFolder"/><xsl:value-of select="tabcolor"/>/tab_about_2.gif</xsl:if>
...
<div>
	...
	<img border="0">
		...
		<xsl:if test="standard='yes'">
			<xsl:attribute name="src"><xsl:value-of select="$imagesFolder"/><xsl:value-of select="tabcolor"/>/tab_about_0.gif</xsl:attribute>
		</xsl:if>
		...
		<xsl:attribute name="onMouseUp">var oArgs=new Object; oArgs.pid='<xsl:value-of select="$objectID"/>'; CallMethod('nav_007_about','MoveTab',oArgs);return false;</xsl:attribute>
	...
	<img border="0">
		...
		<xsl:if test="standard='yes'">
			<xsl:attribute name="src"><xsl:value-of select="$imagesFolder"/><xsl:value-of select="tabcolor"/>/tab_about_3.gif</xsl:attribute>
		</xsl:if>
		<xsl:if test="standard='no'">
